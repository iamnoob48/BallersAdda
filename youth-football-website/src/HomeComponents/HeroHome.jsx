...
export default function HeroHome() {
  ...
  const { profile, academy, loading } = useSelector((state) => state.player);
          ...
          {[1, 2, 3].map((item, i) => (
            ...
            >
              ...
              <div className="p-4">
                ...
                <button
                  onClick={() => navigate("/tournaments")}
                  className={`w-full py-2 rounded-lg border font-medium transition-colors ${dm ? "border-[#87A98D]/20 text-gray-400 group-hover:bg-[#00FF88] group-hover:text-[#121212] group-hover:border-[#00FF88]" : "border-gray-200 text-gray-700 group-hover:bg-green-600 group-hover:text-white group-hover:border-green-600"}`}
                >
                  View Details
                </button>
              </div>
